...
public class ZakupkiHttpClient {
    ...
    private static final String ZAKUPKI_BASE_URL = "http://zakupki.gov.ru/api/mobile/proxy/epz/order/extendedsearch/results.html?morphology=on&pageNumber=1&sortBy=PUBLISH_DATE&sortDirection=false&fz44=on&fz223=on&placingWaysList=KESMBO%2CAESMBO%2CZKESMBO%2CZPESMBO%2CZK504&regions=5277335&currencyId=-1&okpd2Ids=8874109%2C8875827&okpd2IdsWithNested=on";
    @Autowired
    ...
    public List<Tender> getTenders() throws IOException {
        ...
        HttpGet request = new HttpGet(ZAKUPKI_BASE_URL);
