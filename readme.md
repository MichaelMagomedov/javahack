...
На нижней картинке отображена архитектура приложения. Черным цветом выделено то, что было сделано за этот хакатон. Серым цветом отображена дальнейшая разработка. 
Мы обращаемся к площадке по API для поиска тендеров. 
